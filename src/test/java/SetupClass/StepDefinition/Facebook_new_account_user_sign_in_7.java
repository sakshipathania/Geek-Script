...
public class Facebook_new_account_user_sign_in_7 extends SetupClass {
	...
	public void user_navigates_to_fb_login_page_vii() throws Throwable {
		WebElement fb_login_btn = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@id='facebook-signin-btn']")));
		fb_login_btn.click();
		Thread.sleep(3000);
	}
	...
	/*
	 * @Then("^user download a free product vii$") public void
	 * user_download_a_free_product_vii() throws Throwable {
	 * 
	 * driver.get("https://www.slidegeeks.com/free-downloads"); Thread.sleep(6000);
	 * 
	 * WebElement Download= driver.findElement(By.xpath(
	 * "/html/body/div[1]/div[3]/div/section[2]/div/div/div[1]/div/div[2]/div[1]/div/div/p/a/span"
	 * ));
	 * 
	 * //WebElement Download = (WebElement)js.executeScript("('a.btn-download')",
	 * ""); Thread.sleep(3000);
	 * js.executeScript("arguments[0].scrollIntoView();",Download);
	 * Download.click(); Thread.sleep(3000); WebElement download_btn =
	 * driver.findElement(By.
	 * xpath("//a[@class='btn-download pg-button pg-addtocart pg-green-background-btn vwo_subscribe_click']"
	 * )); Thread.sleep(3000);
	 * js.executeScript("arguments[0].scrollIntoView();",Download);
	 * Thread.sleep(3000); download_btn.click(); Thread.sleep(3000);
	 * 
	 * }
	 */
